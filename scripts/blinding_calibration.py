...
from pygama.math.histogram import get_hist, better_int_binning, get_bin_centers
import logging
...
working_dets = [det for det, dic in chmap.map("system", unique=False)["geds"].map("name").items() if dic["analysis"]["processable"]==True  ]
