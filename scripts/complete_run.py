...
argparser.add_argument("--warning_log", help="warning_log", type=str)
argparser.add_argument("--fileDB", help="fileDB", type=str, required=False)
args = argparser.parse_args()

check_log_files(args.log_path, args.summary_log, args.gen_output, warning_file=args.warning_log)
